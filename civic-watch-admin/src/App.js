        ...
        <div className="main-content-wrapper">
          ...
          <main className="main-content">
            <Routes>
              ...
              <Route path="/issues/new" element={<IssuesListPage statusFilter={["Submitted"]} zone={userClaims.zone} title="New Issues" />} />
              <Route path="/issues/on-hold" element={<IssuesListPage statusFilter={["OnHold"]} zone={userClaims.zone} title="On Hold Issues" />} />
              <Route path="/issues/in-progress" element={<IssuesListPage statusFilter={["Approved", "InProgress"]} zone={userClaims.zone} title="Ongoing Resolutions" />} />
              <Route path="/issues/resolved" element={<ResolvedIssuesPage zone={userClaims.zone} />} />
